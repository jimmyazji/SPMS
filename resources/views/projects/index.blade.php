                ...
                <div style="display: none;" x-show="more" class="flex justify-center space-x-2 transition-padding"
                    ...
                    <div date-rangepicker class="flex items-center justify-center space-x-2">
                        ...
                        <div class="relative">
                            ...
                            <x-input id="created_from" name="created_from" datepicker type="text" class="w-28 p-4 pl-8" placeholder="From"
                        ...
                        <div class="relative">
                            ...
                            <x-input id="created_to" name="created_to" datepicker type="text" class="w-28 p-4 pl-8" placeholder="To"
                    ...
                    <div date-rangepicker class="flex items-center space-x-2">
                        ...
                        <div class="relative">
                            ...
                            <x-input id="updated_from" name="updated_from" datepicker type="text" class="w-28 p-4 pl-8"
                                placeholder="From" value="{{ request('updated_from') }}" />
                        </div>
                        <div class="relative"><i class="fa fa-arrow-right"></i></div>
                        <div class="relative">
                            <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                            ...
                            <x-input id="updated_to" name="updated_to" datepicker type="text" class="w-28 p-4 pl-8" placeholder="To" 
                            value="{{ request('updated_to') }}"/>
                        </div>
                    </div>
                    <x-button>Apply</x-button>
                    <a class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-bold text-sm text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150" href="{{ route('projects.index') }}">Reset</a>
                </div>
            </form>
        </div>
    </x-slot>
