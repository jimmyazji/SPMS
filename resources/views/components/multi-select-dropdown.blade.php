...
<div x-data="dropdown()" x-init="loadOptions()" class="relative flex flex-col items-center mx-auto" {{ $attributes }}>
    <form>
        <input name="{{ $name }}" type="hidden" x-bind:value="selectedValues()">
        <div class="inline-block relative w-full">
            <div class="flex flex-col items-center relative">
                <div x-on:click="open" class="w-full  svelte-1l8159u">
                    <div {!! $attributes->merge(['class' =>'h-full flex rounded-md shadow-sm border border-gray-300
                        text-sm text-gray-800 svelte-1l8159u bg-white w-full'])!!}>
                        <div class="flex flex-auto flex-wrap">
                            ...
                            <div x-show="selected.length == 0" class="flex-1 text-sm text-gray-800">
                                <input placeholder="{{ $placeholder }}"
                                    class="bg-white p-1 px-2 appearance-none outline-none h-full w-full text-gray-800"
                        ...
                        <div class="text-sm text-gray-300 w-8 py-0.5 pl-2 pr-1 flex items-center svelte-1l8159u">
                            ...
                            <button type="button"
                                ...
                                <svg version="1.1" class="fill-current h-3 w-3 font-bold" viewBox="0 0 20 20">
